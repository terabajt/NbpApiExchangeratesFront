...
describe('RequestFormComponent', () => {
    ...
    it('should bind input fields to the component properties', () => {
        const currencyInput = fixture.debugElement.query(By.css('input#currency')).nativeElement;
    ...
    it('should call submit and display result when form is submitted', () => {
        ...
        const resultDiv = fixture.debugElement.query(By.css('.mt-4.bg-green-100')).nativeElement;
    ...
    it('should handle errors correctly', async () => {
        ...
        expect(alertSpy).toHaveBeenCalledWith('Currency not found or error occurred');
    });
});
